...
//Lấy ra thư mục sản phẩm
$sql_cat = "SELECT * FROM category ORDER BY cat_id ASC";
$query_cat = mysqli_query($conn, $sql_cat);

//thêm sản phẩm, lv với submit form
if(isset($_POST['sbm'])){
    $prd_name = $_POST['prd_name'];
    $prd_price = $_POST['prd_price'];
    $prd_warranty = $_POST['prd_warranty'];
    $prd_accessories = $_POST['prd_accessories'];
    $prd_promotion = $_POST['prd_poromotion'];
    ...
    prd_accessories, prd_promotion, prd_new, prd_image, cat_id, 
    prd_status, prd_featured, prd_details)
			VALUES('$prd_name', '$prd_price', '$prd_warranty', 
            '$prd_accessories', '$prd_promotion', '$prd_new', 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cat_id" class="form-control">
                                        <?php
                                        //dùng vòng lặp hiển thị danh sách category
