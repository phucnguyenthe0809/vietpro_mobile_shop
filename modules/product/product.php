<?php 
$idPrd=$_GET['prd_id'];
$sql="SELECT * FROM product WHERE prd_id=$idPrd";
...
?>
                ...
                <div id="product">
                    ...
                    if(isset($_POST['sbm']))
                    {
                        ...
                        //định dạng time để add vào database
                        $comm_date = date( 'Y-m-d H:i:s' );
                        $sql="INSERT INTO comment(prd_id, comm_name, comm_mail, comm_date, comm_details)
                       VALUES ('$idPrd', '$comm_name', '$comm_mail', '$comm_date', '$comm_details')";
                    ...
                    <?php 
                        $sql="SELECT * FROM comment WHERE prd_id=$idPrd ORDER BY comm_id DESC";
                        $query=mysqli_query($conn,$sql);
